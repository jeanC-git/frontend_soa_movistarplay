  ...
  data() {
    return {
      ...
      headers_mis_alquileres: [
        ...
        { text: "tipo control", value: "tipo_control" },
      ],
      items: [],
      buscador: "",
    };
  ...
  methods: {
    get_listas() {
      ...
      if (vue.tipo_consumo == 2) {
        ...
        vue.axios
          .get(
            "http://localhost:49220/api/Consumo/MiLista?id_cliente=" +
              id_cliente
          )
        ...
        vue.axios
          .get(
            "http://localhost:49220/api/Consumo/Misalquileres?id_cliente=" +
              id_cliente
          )
          .then(function (response) {
            vue.items = response.data;
    ...
    listarContenidos() {
      ...
      if (buscador == "") {
        ...
        vue.axios
          .get(
            "http://localhost:49220/api/Consumo/busquedahistorial?id_cliente=" +
              id_cliente +
              "&nombre=" +
              vue.buscador
          )
