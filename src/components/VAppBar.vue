        ...
        <v-row color="dark" dark style="display:flex;justify-content:center" class="mb-16">
          <v-col col="12" sm="6" md="4">
            <v-select
              ...
              label="Categoría"
              v-model="buscador_select"
              @change="listar_buscador()"
            ></v-select>
          </v-col>
          <v-col col="12" sm="6" md="4" class="mb-2">
            <v-text-field
              ...
              color="#43aafb"
              v-model="buscador_text"
              @keyup="listar_buscador()"
            ></v-text-field>
          </v-col>
        </v-row>
      </template>
...
export default {
  ...
  methods: {
    listar_buscador(){
      let vue= this;
      vue.$store.state.buscador_select=vue.buscador_select;
      vue.$store.state.buscador_text=vue.buscador_text;
    },
